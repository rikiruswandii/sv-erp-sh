	...
	<div class="flex items-center gap-2 px-4">
		...
		<Breadcrumb.Root>
			<Breadcrumb.List>
				...
				<Breadcrumb.Separator class="hidden md:block" />
				<Breadcrumb.Item>
					<Breadcrumb.Page>Update Page</Breadcrumb.Page>
				</Breadcrumb.Item>
			</Breadcrumb.List>
		</Breadcrumb.Root>
	</div>
...
<div class="hidden h-full flex-1 flex-col gap-8 p-8 md:flex">
	<div class="flex items-center justify-between gap-2">
		<div class="flex flex-col gap-1">
			...
			<p class="text-muted-foreground">Manage and update your page details below.</p>
		</div>
	...
	<form method="post" use:enhance>
		<div class="grid grid-cols-5 gap-4">
			...
			<div class="col-span-5 mt-4 flex items-center justify-end gap-2">
				...
				{:else}
					<Form.Button type="submit" size="sm" class="w-full md:w-auto">Update Page</Form.Button>
				{/if}
			</div>
		</div>
