...
const pages = {
	...
	excerpt: 'View and manage messages submitted through the contact form.'
};
</script>
...
<div class="hidden h-full flex-1 flex-col gap-8 p-8 md:flex">
	<div class="flex items-center justify-between gap-2">
		<div class="flex flex-col gap-1">
			...
			<p class="text-muted-foreground">You have {data?.contact.length} {pages.title.toLocaleLowerCase()}</p>
		</div>
