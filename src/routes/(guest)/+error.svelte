<script lang="ts">
  ...
  console.log("error guest", page.error.status);
</script>
...
<main class="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
  <div class="text-center">
    <p class="text-base font-semibold text-indigo-600">{page.status} (guest)</p>
    <h1 class="mt-4 text-5xl font-semibold tracking-tight text-balance text-gray-900 sm:text-7xl">{page.error?.message}</h1>
